...
public class DownloadManager {
    ...
    public DownloadManager(String APIKey, IComplete iComplete){
        this.APIKey = APIKey;
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url1,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            // Display the first 500 characters of the response string.
                            Movie result = parseExtraDetails(imdbId, response);
                            if(result != null){
    ...
    private Movie parseExtraDetails(String imdbId, String response) {
        ...
        try {
            ...
            return new Movie(title, studio, year,rating, desc,genre,imdbId, poster );
